      ...
      <div className="flex-[0.95] flex flex-col text-white pl-4 pr-1 py-3 justify-between">
        <div className="">
          ...
          <div className=" py-3 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 h-[30rem] overflow-y-auto scrollbar-hide">
              <div className="flex flex-col items-center space-y-1">
                <div className="bg-red-600 flex items-center justify-center w-[5rem] h-[5rem] rounded-xl text-[20px] font-bold">
                  T
                </div>
                <p>Tushar</p>
              </div>
